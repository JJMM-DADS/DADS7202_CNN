...
การทดลองนี้จัดทำขึ้นเพื่อสร้าง model ที่สามารถแบ่งแยกประเภทของหางปลากัด โดยแบ่งออกเป็น 4 กลุ่ม ซึ่งอาศัยการเก็บรวมรวบรูปภาพของปลากัดที่มีลักษณะหางแตกต่างกันตามกลุ่มที่เราสนใจ 
มาใช้เป็น input dataset ของmodel โดยการทดลองนี้มุ่งเน้นการเปรียบเทียบ model-------------
