...
และสุดท้ายเพื่อให้ Dataset มีการกระจายทุก class ไม่ให้ลำดับติดกันเป็นclassเดียวกันทั้งหมด จึงได้ทำการคละลำดับของ dataset ใหม่อีกครั้ง และนำไปใช้งานต่อในการ train model
...
VGG16 มีจุดเด่นคือ การแทนที่ hyperparameter จำนวนมาก เน้นไปที่การออกแบบ layer conv2D ขนาด 3x3 pixels, 1 stride และการใช้ same padding และ 
...
🔅 จากตาราง Confusion matrix และ F1-Score จะพบว่า classที่1 `double` และ classที่2 `halfmoon` มีโอกาส classify ผิดพลาดสูงกว่าclassอื่นๆ ซึ่งแยกผลการ classify ผิดได้ดังนี้
