...
ที่ถูกใช้กับ `VGG16` `ResNet50` และ `EfficientNetB0` โดยใช้เทคนิค `INTER_AREA` ซึ่งเป็นการสุ่มตัวอย่างโดยใช้ความสัมพันธ์เชิงพื้นที่ของพิกเซล <br />
...
มีการกำหนด dense layer มีจำนวน node เป็น 512 และ กำหนด dropout เป็น 0.5 
